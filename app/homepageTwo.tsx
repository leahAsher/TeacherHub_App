...
// Side Nav
const SchoolSideNavigationMenu = ({
  visible,
  onClose,
  setCurrentPage,
}: {
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            Alert.alert(
              "Account Deleted",
              "Your school account has been successfully deleted.",
            );
            onClose();
          },
        },
...
const UploadVacancy = ({
  ...
  const handleSubmit = async () => {
    if (!user) return;
    if (!formData.position || !formData.subject) {
      Alert.alert("Error", "Please fill in the position and subject.");
      return;
    }
    ...
    if (result.success) {
      ...
      Alert.alert("Error", "Failed to post vacancy: " + result.error);
    }
  };
      ...
      <View style={styles.container}>
        <View style={styles.modernHeader}>
          ...
          <Text style={styles.modernHeaderSubtitle}>
            Fill in the details to attract qualified teachers
          </Text>
        </View>
        ...
        <View style={styles.modernCard}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setFormData({ ...formData, employmentType: text })
              }
            />
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setFormData({ ...formData, responsibilities: text })
              }
            />
          </View>
        ...
        <View style={styles.modernCard}>
          ...
          {!showScheduleInterview ?
            <View style={styles.actionButtonsContainer}>
              ...
              <PrimaryButton
                onPress={() =>
                  Alert.alert("Added", `${teacher.name} added to waitlist`)
                }
                color="green"
                style={styles.flex1}
              >
          ...
          : <View style={styles.modernScheduleCard}>
              <Text style={styles.modernScheduleTitle}>
                Schedule Video Interview
              </Text>
...
const SchoolSettings = ({
  ...
  const [positionSearchVisible, setPositionSearchVisible] = useState(profileData?.positionSearchVisible ?? true);
  const [serviceVisible, setServiceVisible] = useState(profileData?.serviceVisible ?? true);
  const [formData, setFormData] = useState({
    schoolName: profileData?.schoolName || "",
    phone: profileData?.phone || "",
    bio: profileData?.bio || "",
    hireCondition: profileData?.hireCondition || "",
  ...
  const handleSaveSettings = async () => {
    ...
    const updatedData = {
      ...formData,
      positionSearchVisible,
      serviceVisible,
      updatedAt: new Date(),
    };

    const result = await updateDocument("users", user.uid, updatedData);
    if (result.success) {
      ...
      return (
        <View style={styles.tabContent}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              style={styles.modernInput}
              placeholder="e.g., Immediate, Next semester"
              placeholderTextColor="#9ca3af"
              value={formData.hireCondition}
              onChangeText={(text) => setFormData({ ...formData, hireCondition: text })}
            />
          </View>
          <View style={styles.inputGroup}>
            <Text style={styles.modernLabel}>Location</Text>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              style={styles.modernInput}
              placeholder="Minimum salary in XAF"
              placeholderTextColor="#9ca3af"
              keyboardType="numeric"
      ...
      return (
        <View style={styles.tabContent}>
          ...
          <View style={styles.modernQualificationCard}>
            <Text style={styles.modernQualificationTitle}>
              Registration Number
            </Text>
            ...
            <PrimaryButton color="indigo" style={styles.saveSmallBtn}>
              Save
            </PrimaryButton>
          </View>
          <View style={styles.modernQualificationCard}>
            ...
            <View style={styles.qualificationItem}>
              <TextInput
                style={styles.modernInput}
                placeholder="Upload or enter certification details"
                placeholderTextColor="#9ca3af"
              />
            </View>
        ...
        <View style={styles.tabContent}>
          ...
          <View style={styles.modernToggleCard}>
            <View style={{ flexShrink: 1 }}>
              ...
              <Text style={styles.modernToggleSubtitle}>
                If disabled, your profile will not appear in job search results.
              </Text>
            </View>
            <Switch
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        <View style={styles.modernHeader}>
          ...
          <Text style={styles.modernHeaderSubtitle}>
            Update your school details, requirements and platform visibility.
          </Text>
        </View>
        <View style={styles.modernCard}>
          <View style={styles.modernTabsContainer}>
            <TouchableOpacity
              style={[
                ...
                activeTab === "profile" && styles.modernActiveTab,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  activeTab === "profile" && styles.modernActiveTabText,
                ]}
              >
                Basic Profile
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.modernTabButton,
                activeTab === "qualifications" && styles.modernActiveTab,
              ]}
            ...
            >
              <Text
                style={[
                  styles.modernTabText,
                  activeTab === "qualifications" && styles.modernActiveTabText,
                ]}
              >
                Qualifications
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.modernTabButton,
                activeTab === "visibility" && styles.modernActiveTab,
              ]}
            ...
            >
              <Text
                style={[
                  styles.modernTabText,
                  activeTab === "visibility" && styles.modernActiveTabText,
                ]}
              >
                Visibility
              </Text>
          ...
          <View style={styles.tabContentPadding}>{renderContent()}</View>
        </View>
      </View>
    </ScrollView>
  );
  ...
  <ScrollView contentContainerStyle={styles.scrollContainer}>
    <View style={styles.container}>
      <View style={styles.modernHeader}>
        ...
        <Text style={styles.modernHeaderSubtitle}>
          Manage your profile, applications and hiring here.
        </Text>
      </View>
      <View style={styles.statsGrid}>
        <StatCard title="Profile Completion" value="85%" color="green" />
        <StatCard title="Active Vacancies" value="-" color="indigo" />
        <StatCard title="Applications" value={applications.length.toString()} color="yellow" />
        <StatCard title="Teachers hired " value="-" color="pink" />
      </View>
      <View style={styles.modernAlertCard}>
        <Text style={styles.modernAlertTitle}>
          Profile Status
        </Text>
        <Text style={styles.modernAlertSubtitle}>
          Keep your institution's profile updated to attract top teaching talent.
        </Text>
        <View style={styles.buttonRow}>
          <PrimaryButton
      ...
      <View style={styles.modernCard}>
        ...
        {applications.length === 0 ? (
          <Text style={styles.modernAppSchool}>No job applications yet.</Text>
        ) : loading ? (
          ...
          applications.map((app) => (
            <View key={app.id} style={styles.modernAppRow}>
              <View style={styles.appDetails}>
                <Text style={styles.modernAppJob}>{app.jobTitle}</Text>
                <Text style={styles.modernAppSchool}>{app.teacherName}</Text>
              </View>
              <View style={styles.appStatusContainer}>
                <View
                  style={[
                    styles.modernAppStatus,
                ...
                <Text style={styles.modernAppDate}>
  ...
  <ScrollView contentContainerStyle={styles.scrollContainer}>
    <View style={styles.container}>
      <View style={styles.modernHeader}>
        <Text style={styles.modernHeaderTitle}>Welcome to TeacherHub</Text>
        <Text style={styles.modernHeaderSubtitle}>
          Find your next teacher, hire top talent.
        </Text>
      </View>
      ...
      <View style={styles.featureList}>
        {teachers.length === 0 ? (
          <Text style={styles.modernAppSchool}>No teachers available yet.</Text>
        ) : loading ? (
          ...
          teachers.map((teacher) => (
            <View key={teacher.id} style={styles.modernFeatureItem}>
              <View style={styles.featureItemHeader}>
                <View style={styles.smallAvatar}>
                  <Text style={styles.smallAvatarText}>
                    {(teacher.username || teacher.name || "T").charAt(0)}
                  </Text>
                </View>
                <View style={styles.featureItemHeaderText}>
                  <Text style={styles.modernFeatureTitle}>{teacher.username || teacher.name}</Text>
                  <Text style={styles.modernFeatureDetail}>
                    {teacher.specialty || teacher.subject || "Teacher"}
                  </Text>
                </View>
              ...
              <View style={styles.buttonRow}>
                ...
                <PrimaryButton
                  onPress={() =>
                    Alert.alert("Added", `${teacher.username || teacher.name} added to waitlist`)
                  }
                  color="green"
                  style={styles.flex1}
                >
...
const App = () => {
  ...
  const fetchData = async () => {
    ...
    const teachersRes = await queryDocuments("users", "userType", "==", "teacher");
    if (teachersRes.success) setTeachers(teachersRes.data || []);

    if (user) {

      const appsRes = await queryDocuments("applications", "schoolId", "==", user.uid);
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "TeacherDashboard":
        return <SchoolDashboard setCurrentPage={setCurrentPage} applications={applications} loading={loading} />;
      case "SchoolSettings":
