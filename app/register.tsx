...
const SignupScreen = () => {
  ...
  const validateField = (field: string, value: string) => {
    ...
    if (field === "username") {
      ...
      else error = validateUsername(value) || "";
    }
    if (field === "email") {
  ...
  const validateAll = () => {
    const usernameError = !username.trim() ? "Username is required." : (validateUsername(username) || "");
    ...
    try {
      ...
      if (result.success && result.user && result.user.uid) {
        ...
        if (dbResult.success) {
          ...
          console.warn("Firestore save failed:", dbResult.error);
        }
      } else {
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  onBlur={() => { setUsernameFocused(false); validateField("username", username); }}
                />
