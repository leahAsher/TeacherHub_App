    ...
    try {
      ...
      if (result.success && result.user && result.user.uid) {
        ...
        if (dbResult.success) {
          ...
          Alert.alert('Success', 'School account created! Note: User data could not be saved to database.');
      ...
      <ScrollView 
        ...
        <View style={styles.container}>
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={styles.subtitle}>Register your institution on Teacher Hub</Text>
          </View>
